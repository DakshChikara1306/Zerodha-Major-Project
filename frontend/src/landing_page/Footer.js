        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5' >
                <div className='col'>
                    ...
                    <p className='mt-3 text-muted'>&copy; 2010 - 2025, Zerodha Broking Ltd.All rights reserved.</p>
                </div>
                <div className='col'>
            ...
            <a href='' style={{color:"blue"}}>Smart Online Dispute Resolution | Grievances Redressal Mechanism</a>
